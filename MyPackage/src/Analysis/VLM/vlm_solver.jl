...
function VLMSolver!(
    setup::VLMSetup, alpha::AbstractVector{<:Float64}, beta::AbstractVector{<:Float64}
)::VLMLoad
...
function _solve_point(setup::VLMSetup, alpha::Float64, beta::Float64)::VLMLoadPoint
    geometry = setup.geometry
    rings, n_panels, n_surfaces, surfaces, wake_map =
...
function _ring_geom!(setup::VLMSetup)::NTuple{3, Matrix{Float64}}
    ...
    geometry = setup.geometry
    result = _assemble_ring_geom(geometry.rings, geometry.n_panels, setup.epsilon2)
