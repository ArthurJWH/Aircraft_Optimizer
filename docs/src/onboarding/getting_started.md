...
**Step 1:** Download [Visual Studio Code](https://code.visualstudio.com/download?_exp_download=fb315fc982) (recommended source code editor)

**Step 2:** Download [Git](https://git-scm.com/install/) for version control.
